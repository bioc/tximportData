...
```
kallisto quant -i kallisto_0.43.0/index -t 6 -b 5 -o kallisto_0.43.0/$f fastq/$f\_1.fastq.gz fastq/$f\_2.fastq.gz
```
...
```
$salmon quant -p 6 --numGibbsSamples 5 -i salmon_0.6.0/index -l IU -1 fastq/$f\_1.fastq.gz -2 fastq/$f\_2.fastq.gz -o salmon_0.6.0/$f
```
